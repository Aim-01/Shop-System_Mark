...
test('8. Successful deletion of the product (last-2, DELETE) ', async ({ request }) => {
  ...
  const lastProduct = products[products.length - 2]; // второй с конца товар выбираем в списке
